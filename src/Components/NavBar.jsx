...
const links = [
  ...
  <div> 
    <h1 className='text-5xl font-signature nl-2'>Maryam</h1>    
    </div>
 ...
 {nav && (
     <ul className='flex flex-col justify-content items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-800 text-gray-500'>
     {links.map(({id, link})=>(
